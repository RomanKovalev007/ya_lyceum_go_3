...
const (
	GeometryService_Area_FullMethodName      = "/pb.GeometryService/Area"
	GeometryService_Perimeter_FullMethodName = "/pb.GeometryService/Perimeter"
)
...
var GeometryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.GeometryService",
